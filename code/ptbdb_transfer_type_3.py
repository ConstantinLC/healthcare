...
def get_model(train = True):
    ...
    dense_1 = Dense(64, activation=activations.relu, name="dense_1", trainable = train)(img_1)
    dense_1 = Dense(64, activation=activations.relu, name="dense_2", trainable = train)(dense_1)
...
model.load_weights('./models/ptbdb_transfer_type_1.h5')
