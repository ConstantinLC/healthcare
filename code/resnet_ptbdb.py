...
def get_model():
    ...
    img_1_keep = Convolution1D(32, kernel_size=5, activation=activations.relu, padding="same")(inp)
    img_1 = Convolution1D(32, kernel_size=5, activation=activations.relu, padding="same")(img_1_keep)
    img_1 = Convolution1D(32, kernel_size=5, activation=activations.relu, padding="same")(img_1)
    img_1 = Add()([img_1_keep, img_1])
